                ...
                <div className="card mb-4">
                    ...
                    <div className="card-body">
                        ...
                        <form onSubmit={handleSaveTemplate}>
                            <div className="mb-3">
                                <label htmlFor="nomModele" className="form-label">{t('manageReportTemplates.form.name')}</label>
                                <input
                                    type="text"
                            ...
                            <div className="mb-3">
                                <label htmlFor="contenuModele" className="form-label">{t('manageReportTemplates.form.content')}</label>
                                <textarea
                                    className="form-control"
                                    id="contenuModele"
                                    name="contenuModele"
